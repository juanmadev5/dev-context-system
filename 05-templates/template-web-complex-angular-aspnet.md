---
tags: [templates, angular, aspnet-core]
---

# Template — Complex web app (Angular + ASP.NET Core)

For a full walk-through of how this file is meant to be used, see [[05-templates/how-to-compose-claude-md|how-to-compose-claude-md]]. Copy the block below into the project's `CLAUDE.md`.
...
- Domain / purpose: ...
- Deviations from the vault's Angular/ASP.NET Core defaults for this project, and why (if any): ...

---

## See also

- [[02-web/angular/angular|angular]], [[03-backend/aspnet-core/aspnet-core|aspnet-core]]
