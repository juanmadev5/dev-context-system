...
- Never design or implement a screen/widget assuming one fixed device size. The realistic range of phone/tablet sizes is in scope **by default** — unlike i18n (see [[01-mobile/flutter/flutter|flutter.md]]'s "Internationalization" section), this isn't a per-project question to ask, it's a standing requirement for any UI work.
