...
- `docs/SOURCES.md` is created the first time it's actually needed, per [[02-web/angular/coding-standards|coding-standards]]'s "no empty folders" reasoning applied to documentation — don't scaffold it empty upfront in a new project.
...
- For this stack, official means: `angular.dev`.
...
- Signal-based inputs: https://angular.dev/guide/signals/inputs

## RxJS

- takeUntilDestroyed: https://angular.dev/guide/rxjs-interop
```
