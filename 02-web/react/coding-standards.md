...
- **Docs** — the project's README was updated if the change affects it ([[00-global/readme-conventions|readme-conventions]]); `docs/SOURCES.md` was updated if external documentation was consulted ([[02-web/react/sources|sources]]).
