...
- `docs/SOURCES.md` is created the first time it's actually needed, per [[02-web/react/coding-standards|coding-standards]]'s "no empty folders" reasoning applied to documentation — don't scaffold it empty upfront in a new project.
...
- For this stack, official means: `react.dev`.
...
- Loader-based data fetching: https://reactrouter.com/en/main/route/loader

## Zustand

- Slicing stores by feature: https://docs.pmnd.rs/zustand/guides/slices-pattern
```
